...
class Counter {
    ...
    constructor(settings) {
        this._id = settings.id || 98642581;
        this._type = settings.type || 0;
        this._onerror = settings.onerror || console.error;
        this._agent = settings.agent || null;

        this._request = {
            host: 'tumenets.github.io/Site-test/',
            url: 'https://tumenets.github.io/Site-test/',
            referer: null,
            'user-agent': null,
            ip: null
        };
    ...
    */
    ...
    /**
     * Для сбора достижение цели.
     *
     * <script>
     *       document.getElementById('button1').addEventListener('click', function() {
     *          fetch('/goal-button-click', {
     *              method: 'GET'
     *          });
     *       });
     *  </script>
